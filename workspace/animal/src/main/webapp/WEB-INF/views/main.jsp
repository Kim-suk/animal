...
<link rel="stylesheet" href="/animal/resources/css/atc03.css">
<!-- script -->
...
<script type="text/javascript" src="/animal/resources/script/logout.js"></script>
            ...
            <div class="txt" style="position: relative; z-index: 2;">
               <div class="main_txt">     
                  <h1 data-aos="fade-left" class="aos-init"
                     style="color: white; font-weight:200; width:100%;max-width:var(--mainsize);position:absolute;left:50%;top:800px;z-index:100;transform:translate(-50%,-50%);color:#fff;letter-spacing:0">Cat & Dog</h1>
                     </div>
               </div>
            </div>
         </div>
                     ...
                     <div class="cont_box">
                        <div class="top_area">
                           <div class="left" data-aos="fade-right">
                              <h2 class="en_tit">
                                 Our<br> <b>Family</b> <span>The one I cherish the most</span>
                              </h2>
                              <div class="ko_box">
                                 <h3 class="tit">
                                 ...
                                 안돼<br> 늙고 병들어도 끝까지 책임지고 사랑해줄 수 있어야 진짜 가족이야.<br>모든 것들을 사랑으로 감싸줄 준비가 되어 있어야 해. 
                                 <a href="/animal/cat/cat_about.do" class="more">
                                 	<img src="https://co1156.shiningcorp.com/sh_img/include/inc01/img/arrow.png" alt="화살표">
                                 </a>
                              </div>
                           </div>
            ...
            <article id="inc02">
               <div class="inner">
                  <div class="top">
                     ...
                     <div class="txt pl">“사랑스러운 친구들을 위한 작은 것들”</div>
                  </div>
               </div>
               <!-- Swiper 슬라이더 영역 -->
                  ...
                  <!-- 자유게시판 -->
                     <article>
                        <a href="${contextPath }/board/getBoardList.do?category=free">
                           ...
                           <div class="cont">
                              <p>자유 게시판</p>
                              <div><br>커뮤니티에 참여해 다양한 이야기를 나눠보세요! 일상, 고민, 유머 등 자유롭게 소통할 수 있는 공간입니다.
								여러분의 이야기를 기다리고 있어요.</div>
                           </div> <span class="arrow"> 
                           <img src="/animal/resources/image/arrow.png" alt="화살표">
                        </span>
                        </a>
                     </article>
					<!-- 고양이 게시판 -->
                     <article>
                        <a href="${contextPath }/board/getBoardList.do?category=cat">
                           <div class="num">02</div>
                           	<div class="cont">
                              <p>고양이 게시판</p>
                              	<div>고양이 집사님들을 위한 공간이에요! 귀여운 고양이 사진, 건강 정보, 꿀팁을 공유해보세요. 
					...
					<!-- 강아지 게시판 -->
                     <article>
                        <a href="${contextPath }/board/getBoardList.do?category=dog">
                           ...
                           <div class="cont">
                              <p>강아지 게시판</p><div>멍멍이들과 함께하는 따뜻한 이야기들이 가득!
                              강아지 산책팁부터 훈련 꿀팁까지 함께 나눠요. 강아지를 사랑하는 분들의 놀이터입니다.</div>
                           </div>
                           	<span class="arrow">
                           <img src="/animal/resources/image/arrow.png" alt="화살표">
                        </span>
