...
<div class="text-center mb-4">
  <button class="tab-button btn btn-outline-secondary me-2" data-tab="vision">시각</button>
  <button class="tab-button btn btn-outline-secondary me-2" data-tab="immunity">면역력</button>
