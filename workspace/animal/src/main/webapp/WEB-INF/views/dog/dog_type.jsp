...
<body>
	<!-- <div data-slider="true" data-type="full" data-mode="fade"
		data-minslides="1" data-maxslides="10" data-controls="true"
		data-adaptiveheight="true" data-autohover="true"
		data-responsive="true" class="smart-banner-wrapper circle"
		data-auto="true" data-speed="500" data-pause="2000"
		data-banner-size-width="1480" data-banner-size-height="800">
		<div class="smart-banner-bx-wrapper">
			<div class="bx-viewport"
				...
				<ul style="width: auto; position: relative; visibility: visible;"
					...
					<li
						style="float: none; list-style: none; position: absolute; width: 1145.39px; z-index: 0; display: block; opacity: 0.564648;"><a
						href="javascript:void(0)%5C;" style="cursor: default"> <img
							src="https://cdn.royalcanin-weshare-online.io/IlZj8noBBKJuub5qQLob/v1/bp-lot-2-pomeranian-color-outdoor"></a></li>
					<li
						style="float: none; list-style: none; position: absolute; width: 1145.39px; z-index: 51; opacity: 0.735352;"><a
						href="javascript:void(0)%5C;" style="cursor: default"> <img
							src="https://cdn.royalcanin-weshare-online.io/uD_H93oBRYZmsWpcK7dZ/v5/bp-lot-1-shiba-couleur-human"></a></li>
					<li
						style="float: none; list-style: none; position: absolute; width: 1145.39px; z-index: 0; display: none;"><a
						href="javascript:void(0)%5C;" style="cursor: default"> <img
							src="https://cdn.royalcanin-weshare-online.io/rz-593oBRYZmsWpcqrfo/v9/bp-lot-1-poodle-couleur-outdoor-2"></a></li>
				</ul>
			</div>
		</div>
	</div> -->
