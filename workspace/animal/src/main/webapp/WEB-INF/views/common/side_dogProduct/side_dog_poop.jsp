    ...
    <aside class="w-64 p-4 border-r bg-white rounded-lg shadow-sm">
        ...
        <div class="filter-group">
            ...
            <div class="filter-options">
                <label class="block"><input type="checkbox" class="mr-2">배변패드</label>
                <label class="block"><input type="checkbox" class="mr-2">배변판</label>
                <label class="block"><input type="checkbox" class="mr-2">탈취제</label>
            </div>
        </div>
        ...
        <div class="filter-group">
            ...
            <div class="filter-options">
                <label class="block"><input type="checkbox" class="mr-2">일반형</label>
                <label class="block"><input type="checkbox" class="mr-2">대형</label>
                <label class="block"><input type="checkbox" class="mr-2">특대형</label>
            </div>
        </div>
        ...
        <div class="filter-group">
            ...
            <div class="filter-options">
                ...
                <label class="block"><input type="checkbox" class="mr-2">유향</label>
            </div>
        </div>
