    ...
    <div id="filterForm">
      ...
      <div class="filter-group">
        ...
        <div class="filter-options">
          <label><input type="checkbox" name="종류" value="볼"> 볼</label>
          <label><input type="checkbox" name="종류" value="낚시대/막대"> 낚시대/막대</label>
          <label><input type="checkbox" name="종류" value="터널/주머니"> 터널/주머니</label>
        </div>
      </div>
      ...
      <div class="filter-group">
        <div class="section-toggle" onclick="toggleSection(this)">
          <span>형태</span><span class="toggle-icon">▼</span>
        </div>
        <div class="filter-options">
          <label><input type="checkbox" name="형태" value="평판형"> 평판형</label>
          <label><input type="checkbox" name="형태" value="기둥형"> 기둥형</label>
        </div>
      </div>
	</div>
  </aside>
