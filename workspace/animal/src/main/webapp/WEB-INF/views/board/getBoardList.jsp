                        ...
                        <tr>
                            ...
                            <div class="w3-row" style="width:400px">
                                <div class="w3-container w3-twothird">    
                                    <input name="searchKeyword" type="text" placeholder="내용을 입력하세요  " class="w3-input w3-border w3-round-large" style="width:260px"/> 
                                </div>
                            ...
                            <td id="td2">
                                <c:if test="${sessionScope.loginId != null}">
                                     <button type="button" onclick="location.href='insertBoard.do?category=${category}'"  class="w3-button w3-round w3-red">
                   ...
                   <div class="w3-container">            
                     <table id="card">
                         <tr>
                             ...
                             <td id="td2">
                                 <img src="/animal/resources/image/comment.png" style="width:15px;height:15px">&nbsp;${board.comment_count}&nbsp;&nbsp;
                                 <img src="/animal/resources/image/love.png" style="width:15px;height:15px">&nbsp;${board.like_it}
                             </td>
                         </tr>
                     </table>
                   </div>
