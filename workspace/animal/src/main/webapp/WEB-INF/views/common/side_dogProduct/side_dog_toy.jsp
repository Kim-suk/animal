    ...
    <div id="filterForm">
      ...
      <div class="filter-group">
        ...
        <div class="filter-options">
          <label><input type="checkbox" name="종류" value="볼/공"> 볼/공</label>
          <label><input type="checkbox" name="종류" value="노즈워크"> 노즈워크</label>
          <label><input type="checkbox" name="종류" value="인형"> 인형</label>
        </div>
      </div>
