...
<div class="container py-5">
  ...
  <ul class="nav nav-tabs mb-4" id="dogTabs" role="tablist">
    <li class="nav-item">
      <button class="nav-link active" id="general-tab" data-bs-toggle="tab" data-bs-target="#general" type="button" role="tab">강아쥐</button>
    </li>
    <li class="nav-item">
      <button class="nav-link" id="rescued-tab" data-bs-toggle="tab" data-bs-target="#rescued" type="button" role="tab">반려견</button>
    </li>
  </ul>
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col">
          <div class="card p-4 text-center">
            ...
            <p class="card-text">강아지의 습성과 건강을 이해하세요. 식습관, 스트레스 반응, 그루밍 등은 필수 지식이에요.</p>
          </div>
        </div>
        <div class="col">
          <div class="card p-4 text-center">
            ...
            <p class="card-text"> 조용하고 안전한 공간에서 신뢰를 쌓아주세요.</p>
          </div>
        </div>
        <div class="col">
          <div class="card p-4 text-center">
            ...
            <p class="card-text">개끗한 곳, 강아지 영역, 창밖 구경할 자리를 마련해 주세요. 급격한 변화는 피하세요.</p>
          </div>
        </div>
        <div class="col">
          <div class="card p-4 text-center">
        ...
        <div class="col">
          <div class="card p-4 text-center">
            ...
            <p class="card-text">강아지의 수명은 평균 10년 ~15년 사이로, 가족으로서 평생 함께할 각오가 필요해요.</p>
          </div>
        </div>
        <div class="col">
          <div class="card p-4 text-center">
