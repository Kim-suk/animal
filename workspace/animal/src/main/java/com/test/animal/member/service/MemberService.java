...
public interface MemberService {
    ...
    MemberDTO memberDetail(String id);            // 회원 상세 정보
    ...
    MemberDTO selectByUserId(String id);          // ID로 조회
    MemberDTO selectByEmail(String email);       // 이메일로 조회
    
    int updateNaverId(MemberDTO member);          // 네이버 ID 연동용 수정
}
