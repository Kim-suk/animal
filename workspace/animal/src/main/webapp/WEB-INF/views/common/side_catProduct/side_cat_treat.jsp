    ...
    <div id="filterForm">
      ...
      <div class="filter-group">
        <div class="section-toggle" onclick="toggleSection(this)">
          <span>급여대상</span><span class="toggle-icon">▼</span>
        </div>
        <div class="filter-options">
          <label><input type="checkbox" name="연령" value="전연령"> 전연령</label>
          <label><input type="checkbox" name="연령" value="키튼"> 키튼(0~1세)</label>
          <label><input type="checkbox" name="연령" value="어덜트"> 어덜트(1~7세)</label>
        </div>
      </div>
      ...
      <div class="filter-group">
        ...
        <div class="filter-options">
          <label><input type="checkbox" name="종류" value="캔"> 캔</label>
          <label><input type="checkbox" name="종류" value="짜먹는간식/퓨레"> 짜먹는간식/퓨레</label>
          <label><input type="checkbox" name="종류" value="동결건조"> 동결건조</label>
        </div>
      </div>
      ...
      <div class="filter-group">
        <div class="section-toggle" onclick="toggleSection(this)">
          <span>기능</span><span class="toggle-icon">▼</span>
        </div>
        <div class="filter-options">
          <label><input type="checkbox" name="기능" value="눈물개선/눈건강"> 눈물개선/눈건상</label>
          <label><input type="checkbox" name="알갱이크기" value="다이어트"> 다이어트</label>
        </div>
      </div>
      </div>
  </aside>
