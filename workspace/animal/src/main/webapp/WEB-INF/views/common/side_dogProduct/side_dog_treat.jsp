    ...
    <div id="filterForm">
      ...
      <div class="filter-group">
        ...
        <div class="filter-options">
          ...
          <label><input type="checkbox" name="연령" value="퍼피"> 퍼피(0~1세)</label>
      ...
      <div class="filter-group">
        ...
        <div class="filter-options">
          ...
          <label><input type="checkbox" name="종류" value="덴탈껌"> 덴탈껌</label>
          <label><input type="checkbox" name="종류" value="건조간식/육포"> 건조간식/육포</label>
        </div>
      </div>
      ...
      <div class="filter-group">
        ...
        <div class="filter-options">
          ...
          <label><input type="checkbox" name="알갱이크기" value="귀건강"> 귀건강</label>
        </div>
      </div>
      </div>
  </aside>
