package com.test.animal.dog_board.dao;
 ...
 public class DogBoardDAOImpl implements DogBoardDAO {
 	...
 	public List<DogArticleDTO> dog_listArticles() {
 		...
 		return sqlSession.selectList("mapper.board.dog_selectAllArticlesList");
 	}
 
 	@Override
 	public int dog_selectNewArticleNo() {
 		// TODO Auto-generated method stub
 		return sqlSession.selectOne("mapper.board.dog_selectNewArticleNo");
 	}
 
 	@Override
 	public int dog_insertNewArticle(Map<String, Object> articleMap) {
 		// TODO Auto-generated method stub
 		sqlSession.insert("mapper.board.dog_insertNewArticle", articleMap);
 	...
 	public DogArticleDTO dog_viewArticle(int articleNo) {
 		// TODO Auto-generated method stub
 		return sqlSession.selectOne("mapper.board.dog_selectArticle", articleNo);
 	}
 
 	@Override
 	public void dog_updateArticle(Map<String, Object> articleMap) {
 		// TODO Auto-generated method stub
 		sqlSession.update("mapper.board.dog_updateArticle", articleMap);
 	}
 
 	@Override
 	public void dog_deleteArticle(int articleNo) {
 		// TODO Auto-generated method stub
 		sqlSession.delete("mapper.board.dog_deleteArticle", articleNo);
 	}
 
 	@Override
 	public int dog_selectNewImageFileNo() {
 		// TODO Auto-generated method stub
 		return sqlSession.selectOne("mapper.board.dog_selectNewImageFileNo");
 	}
 
 	@Override
 	public void dog_insertNewImage(List<DogImageDTO> imageFileList) {
 		// TODO Auto-generated method stub
 		sqlSession.insert("mapper.board.dog_insertNewImage", imageFileList);
 	}
 
 	@Override
 	public List<DogImageDTO> dog_selectImageFileList(int articleNo) {
 		// TODO Auto-generated method stub
 		return sqlSession.selectList("mapper.board.dog_selectImageFileList", articleNo);
 	}
 
 	@Override
 	public int dog_deleteImage(int imageFileNo) {
 		// TODO Auto-generated method stub
 		return sqlSession.delete("mapper.board.dog_deleteImage", imageFileNo);
 	}
 
 	@Override
 	public int dog_selectArticleNo(int imageFileNo) {
 		// TODO Auto-generated method stub
 		return sqlSession.selectOne("mapper.board.dog_selectArticleNo", imageFileNo);
 	}
